...
//
// class SearchMapPlaceBox extends StatefulWidget {
//   SearchMapPlaceBox({
...
//
//   @override
//   _SearchMapPlaceBoxState createState() => _SearchMapPlaceBoxState();
// }
//
// class _SearchMapPlaceBoxState extends State<SearchMapPlaceBox>
...
//               ),
//             ),
//           if (!widget.hasClearButton) Icon(
//               widget.icon, color: widget.iconColor),
//           Container(width: 20),
//           Expanded(
//             child: TextField(
...
//       child: ListTile(
//         title: Text(
//           place.length < 45 ? "$place" : "${place.replaceRange(
//               45, place.length, "")} ...",
//           style: TextStyle(
//             fontSize: MediaQuery
//                 .of(context)
...
//         .apiKey}&language=${widget.language}";
